...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	,
}
...
type GreetServiceClient interface {
	...
	// Client streaming
	LognGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LognGreetClient, error)
	//  Bidirectional
...
func (c *greetServiceClient) LognGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LognGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[1], "/greet.GreetService/LognGreet", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceLognGreetClient{stream}
	return x, nil
}

type GreetService_LognGreetClient interface {
	Send(*LongGreetRequest) error
	CloseAndRecv() (*LongGreetReponse, error)
	grpc.ClientStream
}

type greetServiceLognGreetClient struct {
	grpc.ClientStream
}

func (x *greetServiceLognGreetClient) Send(m *LongGreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLognGreetClient) CloseAndRecv() (*LongGreetReponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	// Client streaming
	LognGreet(GreetService_LognGreetServer) error
	//  Bidirectional
...
func (*UnimplementedGreetServiceServer) LognGreet(srv GreetService_LognGreetServer) error {
	return status.Errorf(codes.Unimplemented, "method LognGreet not implemented")
}
...
func _GreetService_LognGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).LognGreet(&greetServiceLognGreetServer{stream})
}

type GreetService_LognGreetServer interface {
	SendAndClose(*LongGreetReponse) error
	Recv() (*LongGreetRequest, error)
	grpc.ServerStream
}

type greetServiceLognGreetServer struct {
	grpc.ServerStream
}

func (x *greetServiceLognGreetServer) SendAndClose(m *LongGreetReponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLognGreetServer) Recv() (*LongGreetRequest, error) {
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "LognGreet",
			Handler:       _GreetService_LognGreet_Handler,
			ClientStreams: true,
		},
		{
